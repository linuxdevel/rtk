...
See [Dangerous Patterns Reference](https://github.com/linuxdevel/rtk/wiki/Dangerous-Patterns) for exploitation examples.
...
- **General questions**: https://github.com/linuxdevel/rtk/discussions
