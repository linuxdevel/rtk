...
Download from [releases](https://github.com/linuxdevel/rtk/releases):
...
| **Mistral Vibe** | Planned ([#800](https://github.com/linuxdevel/rtk/issues/800)) | Blocked on upstream |
...
<a href="https://www.star-history.com/?repos=linuxdevel%2Frtk&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=linuxdevel/rtk&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=linuxdevel/rtk&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=linuxdevel/rtk&type=date&legend=top-left" />
 </picture>
</a>

## StarMapper

<a href="https://starmapper.bruniaux.com/linuxdevel/rtk">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://starmapper.bruniaux.com/api/map-image/linuxdevel/rtk?theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://starmapper.bruniaux.com/api/map-image/linuxdevel/rtk?theme=light" />
    <img alt="StarMapper" src="https://starmapper.bruniaux.com/api/map-image/linuxdevel/rtk" />
  </picture>
</a>

## Contributing

Contributions welcome! Please open an issue or PR on [GitHub](https://github.com/linuxdevel/rtk).
