...
fn run_status() -> Result<()> {
    ...
    println!();
    println!("Data controller: linuxdevel/rtk maintainers, security@rtk-ai.dev");
    println!("Details: https://github.com/linuxdevel/rtk/blob/master/docs/TELEMETRY.md");
...
fn run_enable() -> Result<()> {
    ...
    eprintln!("  Who:     linuxdevel/rtk maintainers, security@rtk-ai.dev");
    eprintln!("  Details: https://github.com/linuxdevel/rtk/blob/master/docs/TELEMETRY.md");
    eprintln!();
    ...
    if let Some(hash) = device_hash {
        match send_erasure_request(&hash) {
            ...
            Err(e) => {
                ...
                eprintln!("  To complete erasure, email security@rtk-ai.dev");
