...
```bash
curl -fsSL https://raw.githubusercontent.com/linuxdevel/rtk/master/install.sh | sh
```
...
- **GitHub issues**: https://github.com/linuxdevel/rtk/issues
- **Pull Requests**: https://github.com/linuxdevel/rtk/pulls
